...
hl.monitor({
    output="desc:Dell Inc. DELL U2723QE HFVHZG3",
    mode="3840x2160@60.00",
    position="0x0",
    scale=1.250
})
hl.monitor({
    output="desc:Dell Inc. DELL U2720Q D4G0Y13",
    mode="3840x2160@60.00",
    position="3072x0",
    scale=1.250
})
...
hl.bind(mainMod .. " + slash", hl.dsp.workspace.toggle_special("chatgpt"))
hl.bind(mainMod .. " + SHIFT + slash", hl.dsp.window.move( { workspace = "special:chatgpt" }))
hl.bind(mainMod .. " + T", hl.dsp.workspace.toggle_special("teams"))
hl.bind(mainMod .. " + SHIFT + T", hl.dsp.window.move( { workspace = "special:teams" }))
...
-- Dell KVM
hl.bind(mainMod .. " + SHIFT + P", hl.dsp.exec_cmd("/home/tom/.local/bin/kvm_switch laptop"))
